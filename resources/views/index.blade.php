			...
			<div class="col-lg-12 col-sm-12 col-md-12 slider-wrap">
	               ...
	               <div class="slider-item-content">
						<div class="post-thumb mb-4">
							<a href="blog-single.html">
								<img src="{{url('assets/forntend')}}/images/slider/slider1.jpg" alt="" class="img-fluid">
							</a>
						</div>
	            ...
	            <div class="slider-item">
	               <div class="slider-item-content">
						<div class="post-thumb mb-4">
							<a href="blog-single.html">
								<img src="{{url('assets/forntend')}}/images/slider/slider2.jpg" alt="" class="img-fluid">
							</a>
						</div>
						<div class="slider-post-content">
	            ...
	            <div class="slider-item">
	               <div class="slider-item-content">
						<div class="post-thumb mb-4">
							<a href="blog-single.html">
								<img src="{{url('assets/forntend')}}/images/slider/slider3.jpg" alt="" class="img-fluid">
							</a>
						</div>
						<div class="slider-post-content">
